...
const Stop: JSX.Element = (
  <svg xmlns="http://www.w3.org/2000/svg" className="m-auto" width="18" height="18" fill="currentColor" viewBox="0 0 16 16">
...
const icons: IconsType = { Sun, Moon, Listen, Swap, Close, Copy, Paste, Search, Check, Stop, Chevron, Github };
